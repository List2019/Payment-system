...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `credit_card_BEFORE_UPDATE` BEFORE UPDATE ON `credit_card` FOR EACH ROW BEGIN
INSERT INTO logger
SET time_transaction = now(),
